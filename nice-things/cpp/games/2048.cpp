...
class Game2048
{
	...
	public:
		...
		// metoda wyswietlajaca sterowanie
		static void print_controls()
		{
			...
			cout << "Nacisnij dowolna litere aby rozpoczac nowa gre" << endl;
			cout << "lub Q aby wyjsc z gry" << endl;
			cout << "-----------------------------------------------\n";
		...
		// metoda wyswietlajaca glowne menu i zwracajaca wybrana opcje
		static unsigned short main_menu(const char CLEAR[])
		{
			char input;
...
int main()
{
	...
	unsigned short position = Game2048::main_menu(CLEAR);
